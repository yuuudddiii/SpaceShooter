...
public class Player2 : MonoBehaviour
{
    ...
    {
        CalculateMovement();
        if (Input.GetKeyDown(KeyCode.RightShift) && (Time.time > _nextFire))
        {
            shootLaser();
        }
    }
    ...
    {
        float horizontalInput = Input.GetAxis("Alt_Horizontal");
        float verticalInput = Input.GetAxisRaw("Alt_Vertical");
    ...
    public void damageTaken()
    {
        ...
        if (_lives < 1 && _player1.getLives() < 1)
        {
